...
import { createWeight, fetchMeasures, deleteMeasure } from '../actions';
...
class WeightForm extends React.Component {
  ...
  onSubmitDelete = async e => {
    ...
    let arrayLenght = this.props.terveysdata[5].length - 1
    let measureId = this.props.terveysdata[5][arrayLenght].MeasureID
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, { createWeight, fetchMeasures, deleteMeasure })(WeightForm);